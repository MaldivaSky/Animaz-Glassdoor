$webLogoPath = "c:\Users\g010792832\Desktop\Animaz Glassdoor\assets\logo_web.png"
Invoke-WebRequest -Uri "https://animaz.f1cdn.com.br/parametros_gerais/170/94/true/false/16946268791365.png" -OutFile $webLogoPath
...
$logoImg = [System.Drawing.Image]::FromFile($webLogoPath)
$logoHeight = 50
